                        ...
                        <div className="w-full flex flex-col items-center">
                            ...
                            {isContactOpen && (
                                <div className="mt-3 w-3/4 bg-white rounded-xl shadow-md p-3 text-center">
                                    <a onClick={() => { setIsMenuOpen(false); setIsContactOpen(false); }} href="https://t.me/BIGBIGNONO" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-3 py-2 rounded-md hover:bg-gray-100 text-sm text-gray-800">
                                        <Send size={16} className="text-blue-500 mr-2" />
                                        <span>Martin</span>
                                    </a>
                                    <a onClick={() => { setIsMenuOpen(false); setIsContactOpen(false); }} href="https://t.me/Elma_R09" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center px-3 py-2 rounded-md hover:bg-gray-100 text-sm text-gray-800">
                                        <Send size={16} className="text-blue-500 mr-2" />
                                        <span>Elma</span>
                                    </a>
                                </div>
